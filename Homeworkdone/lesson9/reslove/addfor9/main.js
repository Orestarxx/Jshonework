...
for (const element of usersList) {
    ...
    zip.innerHTML =`Zipcode:${element.address.zipcode}`;
    ...
    web.innerHTML =`<b>webSite:</b>${element.website}`;
    ...
    nameFourth.innerHTML =`Name:${element.company.name}`;
    company.appendChild(nameFourth);
    let catchF = document.createElement(`div`);
    catchF.classList.add(`fourth`);
    catchF.innerHTML =`CatchFrase:${element.company.catchPhrase}`;
